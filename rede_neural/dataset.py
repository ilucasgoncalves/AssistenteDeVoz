...
class RandomCut(nn.Module):
    "" "Técnica de augumento que corta aleatoriamente o início ou o fim do áudio" ""
    ...
    def forward(self, x):
        "" "Corta aleatoriamente do início ou final da batch" ""
...
class SpecAugment(nn.Module):
    ...
    "" "Técnica de augumento para adicionar mascaramento no domínio do tempo ou frequência" ""
...
class WakeWordData(torch.utils.data.Dataset):
    "Carregar e processar dados do wakeword"
